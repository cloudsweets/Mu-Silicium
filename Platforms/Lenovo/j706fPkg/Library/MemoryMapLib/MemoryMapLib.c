...
gMemoryRegionDescriptorEx[] = {
  ...
  // DDR Regions
  {"HLOS 1",             0x80000000, 0x05700000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN},
  {"HYP",                0x85700000, 0x00600000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  ...
  {"QTEE",               0x86200000, 0x00B00000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
  {"TZApps",             0x86D00000, 0x02200000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE},
  {"HLOS 2",             0x88F00000, 0x01C00000, AddMem, SYS_MEM, SYS_MEM_CAP, BsData, WRITE_BACK_XN},
  {"PIL_REGION",         0x8AB00000, 0x0D300000, AddMem, MEM_RES, UNCACHEABLE, Reserv, UNCACHED_UNBUFFERED_XN},
  {"DXE Heap",           0x97E00000, 0x03E00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
